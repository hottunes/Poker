...
import { JamLink } from "./ui/JamLink.js";
...
export class Game {
    constructor(container) {
        ...
        // Initialize JamLink
        this.jamLink = new JamLink();

        // Check if user came from portal
        ...
        if (isFromPortal) {
            ...
            // Skip name input and profile selection if coming from portal
            this.character.setProfile(username, 1);
            this.initializeGame();
        } else {
            // Show normal start flow
    ...
    initializeGame() {
        ...
        this.portalUI = new PortalUI(this);

        // z-index 조정
        this.characterUI.container.style.zIndex = "1000";
        this.tournamentUI.container.style.zIndex = "1001";
        this.characterProfile.container.style.zIndex = "1002";
        this.portalUI.container.style.zIndex = "9999";
        ...
        document.body.appendChild(this.portalUI.container);
