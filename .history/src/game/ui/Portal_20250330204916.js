...
export function Portal({ type = "exit", position = "top-right" }) {
    ...
    return (
        <button
            ...
            className={`fixed ${positionStyles[position]} z-[9999] bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center gap-2 cursor-pointer`}
            style={{
