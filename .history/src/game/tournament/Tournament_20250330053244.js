...
export class Tournament {
    ...
    calculateInitialResult(character) {
        ...
        const prize = !isFinalTable
            ? this.prizeSystem.calculatePrize(rank, this.prizePool, this.type)
            : 0;
    ...
    getFinalTableResult(character, initialResult) {
        ...
        // 파이널 테이블 상금 계산
        const finalTablePrize = this.prizeSystem.calculatePrize(
            initialResult.rank,
            this.prizePool,
            this.type
        );
        ...
        const finalResult = {
            ...
            prize: finalTablePrize, // 새로 계산된 상금 사용
            isInMoney: true,
            isFinalTable: true,
