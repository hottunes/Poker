...
export class TournamentUI {
    ...
    createTournamentCard(tournament) {
        ...
        button.style.cssText = `
            ...
            padding: 8px;
            margin-top: 10px;
            background: ${this.isPendingFinalTable ? "#666" : "#4CAF50"};
            border: none;
            border-radius: 4px;
        ...
        // 버튼 텍스트 색상을 흰색으로 강제 설정
        button.setAttribute(
            "style",
            button.getAttribute("style") + " color: white !important;"
        );
    ...
    showFinalTableResult(finalResult) {
        ...
        resultInfo.innerHTML = `
            ...
            <div style="color: #4CAF50">${this.language.t(
