export class Tournament {
    ...
    calculateFinalTableScore(character) {
        ...
        // 스킬 점수를 0-60점 범위로 정규화 (500을 기준으로)
        skillScore = (skillScore / 500) * 60;
    ...
    calculateScore(character) {
        ...
        const analysisBonus =
            (1 - remainingPlayersRatio) * (character.stats.analysis / 500) * 10;
    ...
    generateNPCScore() {
        // NPC 스킬 레벨 (0-60점 범위)
        const baseSkillLevel = 18; // 기본 스킬 레벨 (300 스탯에 해당, 30% 수준)

        // 스킬 레벨에 약간의 변동성 추가 (±3점)
        const skillVariation = Math.random() * 6 - 3;
