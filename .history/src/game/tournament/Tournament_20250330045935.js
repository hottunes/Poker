...
export class Tournament {
    constructor(type = "online") {
        this.type = type;
        this.maxPlayers = type === "online" ? 1000 : 100;
        this.buyIn = type === "online" ? 1000 : 10000;
        this.prizePool = this.maxPlayers * this.buyIn;
        this.results = [];
        this.npcSystem = new TournamentNPC(type);
    ...
    calculateInitialResult(character) {
        ...
        const prize = !isFinalTable
            ? this.prizeSystem.calculatePrize(
                  rank,
                  this.prizePool,
                  this.maxPlayers
              )
