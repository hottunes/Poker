...
export class Tournament {
    ...
    calculateSkill(character) {
        ...
        // 실제 리소스값 사용 (0-1000 스케일)
        return (
            (resources.strategy || 0) * weights.strategy +
            (resources.analysis || 0) * weights.analysis +
            (resources.aggressive || 0) * weights.aggressive +
            (resources.defensive || 0) * weights.defensive
        );
    }
