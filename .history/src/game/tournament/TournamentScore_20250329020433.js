export class TournamentScore {
    ...
    calculateSkill(character) {
        ...
        // 가중치 적용하여 실력 점수 계산
        return (
            normalized.strategy * this.weights.strategy +
            normalized.analysis * this.weights.analysis +
            normalized.insight * this.weights.insight +
            normalized.mentalFocus * this.weights.mentalFocus +
            normalized.stamina * this.weights.stamina
        );
    }
