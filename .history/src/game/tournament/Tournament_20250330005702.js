...
export class Tournament {
    ...
    calculateSkill(character) {
        ...
        // 각 스탯을 0~1 범위로 정규화 (500을 0.7로 매핑)
        const normalized = {
            strategy: (character.stats.strategy / 714) * 0.7,
            analysis: (character.stats.analysis / 714) * 0.7,
            insight: (character.stats.insight / 714) * 0.7,
            mentalFocus: (character.stats.mentalFocus / 714) * 0.7,
            stamina: (character.stats.stamina / 714) * 0.7,
        };
