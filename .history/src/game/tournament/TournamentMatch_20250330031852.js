export class TournamentMatch {
    ...
    calculateScore(character) {
        let skill;
        if (character.isNPC) {
            // NPC의 경우 이미 0-1000 범위의 스킬을 가지고 있음
            skill = character.skill / 1000;
        } else {
            // 플레이어의 경우 calculateSkill을 통해 계산
            skill = this.calculateSkill(character) / 1000;
        }
